      ...
      <div class="flex flex-column align-items-center justify-content-center w-full md:w-4 h-full text-center py-6 px-4">
        ...
        <div class="flex flex-column">
                    <span class="p-input-icon-left w-full mb-4">
                        ...
                        <InputText v-model="form.name" id="username" type="text" class="w-full md:w-25rem text-color-secondary surface-50 border-200" placeholder="Username" />
                    </span>
          <span class="p-input-icon-left w-full mb-4">
          ...
          <span class="p-input-icon-left w-full mb-4">
                        ...
                        <Password v-model="form.password" id="password" placeholder="Password" class="w-full" :inputStyle="{ paddingLeft: '2.5rem' }" inputClass="w-full md:w-25rem text-color-secondary surface-50 border-200" toggleMask></Password>
                    </span>
          <span class="p-input-icon-left w-full mb-4">
                        <i class="pi pi-lock z-2"></i>
                        <Password v-model="form.password_confirmation" id="password_confirmation" placeholder="Confirm Password" class="w-full" :inputStyle="{ paddingLeft: '2.5rem' }" inputClass="w-full md:w-25rem text-color-secondary surface-50 border-200" toggleMask :feedback="false"></Password>
                    </span>
          <div class="mb-4 flex flex-wrap align-items-center">
            <Checkbox name="checkbox" value="val" class="mr-2" :binary="true"></Checkbox>
          ...
          <Button label="Sign Up" class="w-full mb-4" @click="submit"></Button>
          <span class="font-medium text-600">Already have an account?<Link class="font-semibold cursor-pointer text-900 hover:text-primary transition-colors transition-duration-300" :href="route('login')"> Login </Link></span>
        </div>
      </div>
